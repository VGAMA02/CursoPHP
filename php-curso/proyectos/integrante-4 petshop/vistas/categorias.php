			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmCategorias">
						...
						<input type="text" class="form-control input-sm" name="categoria" id="categoria" required pattern="[A-Za-z0-9]+"> <!--validacion implementada-->
						<p></p>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="frmCategoriaU">
							<input type="text" hidden="" id="idcategoria" name="idcategoria" required pattern="[A-Za-z0-9]+"> <!--validacion implementada-->
							<label>Categoria</label>

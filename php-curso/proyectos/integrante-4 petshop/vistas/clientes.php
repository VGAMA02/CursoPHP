		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmClientes">
						<label>Nombre</label>
						<input type="text" class="form-control input-sm" id="nombre" name="nombre" required pattern="[A-Za-z0-9]+">
						<label>Apellido</label>
						<input type="text" class="form-control input-sm" id="apellidos" name="apellidos" required pattern="[A-Za-z0-9]+">
						<label>Direccion</label>
						<input type="text" class="form-control input-sm" id="direccion" name="direccion" required pattern="[A-Za-z0-9]+">
						<label>Email</label>
						<input type="text" class="form-control input-sm" id="email" name="email">
						<label>Telefono</label>
						<input type="number" class="form-control input-sm" id="telefono" name="telefono" min="0">
						<label>RFC</label>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="frmClientesU">
							...
							<label>Nombre</label>
							<input type="text" class="form-control input-sm" id="nombreU" name="nombreU" required pattern="[A-Za-z0-9]+">
							<label>Apellido</label>
							<input type="text" class="form-control input-sm" id="apellidosU" name="apellidosU" required pattern="[A-Za-z0-9]+">
							<label>Direccion</label>
							<input type="text" class="form-control input-sm" id="direccionU" name="direccionU" required pattern="[A-Za-z0-9]+">
							<label>Email</label>
							<input type="text" class="form-control input-sm" id="emailU" name="emailU">
							<label>Telefono</label>
							<input type="number" class="form-control input-sm" id="telefonoU" name="telefonoU" min="10">
							<label>RFC</label>

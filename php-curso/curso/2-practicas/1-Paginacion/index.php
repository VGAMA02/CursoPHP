...
$notifier = new Airbrake\Notifier//estas dos lineas no van aqui(array(
    'projectId' => 327163,
    'projectKey' => '418636609cffda4e259ccc5a5db6ff43'
));
...
$articulos = $conexion->prepare("
	SELECT SQL_CALC_FOUND_ROWS * FROM articuloslocales
